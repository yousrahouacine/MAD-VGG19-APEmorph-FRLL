...
# EMBEDDINGS (MTCNN OFFLINE PIPELINE)
APE_TRAIN_DIR = WORKSPACE / "embeddings_apemorph_train"
APE_TEST_DIR  = WORKSPACE / "embeddings_apemorph_test"
FRLL_DIR      = WORKSPACE / "embeddings_frll"
...
OUT_FIG = OUT_DIR / "tsne_APE_train_test_FRLL_6groups_mtcnn.png"
...
plt.title(
    "t-SNE visualization of VGG19 embeddings (MTCNN offline)\n"
