...
# PATHS
# ==========================
CSV_IN = "/content/drive/MyDrive/workspace3/apemorph_train_balanced.csv"
IMG_ROOT = "/content/drive/MyDrive/workspace3" 

OUT_IMG_DIR = "/content/drive/MyDrive/workspace3/apemorph_train_mtcnn"
OUT_CSV = "/content/drive/MyDrive/workspace3/apemorph_train_balanced_mtcnn.csv"
...
print("MTCNN preprocessing completed")
